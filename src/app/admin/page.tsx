      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
             ...
             <span className="text-[10px] uppercase tracking-[0.4em] text-accent-gold">Executive Summary</span>
          </div>
          <h1 className="text-5xl tracking-[-0.04em] uppercase text-primary">Overview</h1>
        </div>
        <div className="flex items-center gap-4 bg-white px-8 py-4 rounded-3xl border border-neutral-100 shadow-luxury">
           ...
           <span className="text-[11px] uppercase tracking-[0.2em] text-secondary">System Online • May 2026</span>
        </div>
      </div>
          ...
          <div key={stat.name} className="bg-white p-10 rounded-[48px] border border-neutral-50 shadow-luxury hover:shadow-luxury-hover transition-all duration-700 group">
             <div className="flex justify-between items-start mb-10">
                ...
                <div className="flex flex-col items-end gap-1">
                   <span className="text-[9px] text-primary uppercase tracking-widest opacity-40">Dynamic</span>
                   <div className="flex items-center text-[10px] text-green-600 bg-green-50 px-3 py-1 rounded-full uppercase">
                     {stat.change}
                   </div>
                </div>
             </div>
             <div className="space-y-2">
                <h3 className="text-4xl tracking-tight text-primary">{stat.value}</h3>
                <p className="text-[10px] text-neutral-300 uppercase tracking-[0.3em]">{stat.name}</p>
             </div>
          </div>
        ))}
      </div>
        ...
        <div className="lg:col-span-8 bg-white rounded-[56px] border border-neutral-50 shadow-luxury overflow-hidden">
           <div className="p-10 border-b border-neutral-50 flex justify-between items-center bg-cream-light/20">
              <div className="space-y-1">
                 <h2 className="text-xl uppercase tracking-tight">Recent Masterpieces</h2>
                 <p className="text-[10px] uppercase tracking-[0.2em] text-neutral-300">Latest additions to the atelier</p>
              </div>
           ...
           <div className="p-6">
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead>
                    <tr className="text-[10px] text-neutral-300 uppercase tracking-[0.3em] border-b border-neutral-50">
        ...
        <div className="lg:col-span-4 space-y-8">
           <div className="bg-primary text-white p-12 rounded-[56px] shadow-luxury relative overflow-hidden group border border-white/5">
              ...
              <div className="relative z-10 space-y-10">
                <div className="space-y-2">
                   <span className="text-accent-gold text-[10px] uppercase tracking-[0.4em]">TH Control</span>
                   <h3 className="text-2xl uppercase leading-tight tracking-tight">Quick <br /> Curation</h3>
                </div>
                <div className="space-y-4">
                   <Link href="/admin/products/new" className="flex items-center justify-between w-full bg-white text-black h-20 rounded-[24px] px-8 uppercase tracking-[0.2em] text-[10px] hover:bg-accent-gold hover:text-white transition-all duration-500 shadow-xl group/btn">
                      <span>Add Masterpiece</span>
                      <Plus size={18} className="group-hover/btn:rotate-90 transition-transform duration-500" />
                   </Link>
                   <button className="flex items-center justify-between w-full bg-white/5 border border-white/10 text-white h-20 rounded-[24px] px-8 uppercase tracking-[0.2em] text-[10px] hover:bg-white/10 transition-all duration-500">
