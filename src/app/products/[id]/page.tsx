...
import { ChevronRight, Info, Minus, Plus, CheckCircle2, Box, Loader2, Image as ImageIcon, Rotate3D, Sparkles, MessageCircle, ArrowRight, ShieldCheck, Truck, Star } from 'lucide-react';
...
export default function ProductDetail() {
  ...
  // Idea 5: Soft Parallax for the main image
