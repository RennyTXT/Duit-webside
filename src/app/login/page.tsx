      ...
      <div className="max-w-md w-full bg-white rounded-[32px] sm:rounded-[40px] p-8 sm:p-12 shadow-luxury border border-neutral-100 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8 sm:space-y-10">
          <div className="text-center space-y-4">
            <h1 className="text-3xl sm:text-4xl uppercase tracking-tighter text-primary">Login</h1>
            <p className="text-[10px] uppercase tracking-[0.3em] text-accent-gold">Access the Inner Circle</p>
          </div>
