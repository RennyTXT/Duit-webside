    ...
    <div className="bg-white min-h-screen pt-20 pb-32">
      <div className="max-w-3xl mx-auto px-6">
        <div className="py-24 space-y-8">
          ...
          <h1 className="text-4xl md:text-5xl tracking-tighter uppercase">Terms of Service</h1>
          <p className="text-sm text-neutral-400 uppercase tracking-ultra">Effective Date: May 2026</p>
        </div>

        <div className="space-y-16 text-secondary font-medium leading-relaxed">
           <section className="space-y-6">
              <h2 className="text-xl text-primary uppercase flex items-center gap-3">
           ...
           <div className="p-10 bg-neutral-50 rounded-[40px] border border-neutral-100 italic space-y-4">
              <p className="text-sm text-primary uppercase tracking-wider underline decoration-accent decoration-2 underline-offset-4">คำชี้แจงความรับผิดชอบ:</p>
           ...
           <section className="space-y-6">
              <h2 className="text-xl text-primary uppercase">4. การเปลี่ยนแปลงเงื่อนไข</h2>
           ...
           <div className="text-center pt-16 border-t border-neutral-100">
              <p className="text-[10px] uppercase tracking-ultra text-neutral-400">Duit Thailand | Official Terms</p>
           </div>
        </div>
      </div>
    </div>
